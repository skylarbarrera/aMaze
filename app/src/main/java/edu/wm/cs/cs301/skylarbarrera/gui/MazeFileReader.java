...
import edu.wm.cs.cs301.skylarbarrera.generation.BSPBranch;
import edu.wm.cs.cs301.skylarbarrera.generation.BSPLeaf;
import edu.wm.cs.cs301.skylarbarrera.generation.BSPNode;
...
import edu.wm.cs.cs301.skylarbarrera.generation.MazeContainer;
import edu.wm.cs.cs301.skylarbarrera.generation.Seg;
...
public class MazeFileReader {
	...
	private static Seg readSegment(Element eElement, int number, int i) {
		...
		int[] rgb = getRGBALL(col);
		
		result.setColor(rgb[0], rgb[1], rgb[2]); 
	...
	private static int[] getRGBALL(int rgb) {
