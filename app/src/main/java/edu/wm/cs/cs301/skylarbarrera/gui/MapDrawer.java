	...
	private void drawMap( int px, int py, int walkStep, 
		...
		for (int y = minY; y <= maxY; y++)
			for (int x = minX; x <= maxX; x++) {
				...
				mp.setColor(seenCells.hasWall(x,y, CardinalDirection.North) ? white : gray);
				...
				mp.setColor(seenCells.hasWall(x,y, CardinalDirection.West) ? white : gray);
